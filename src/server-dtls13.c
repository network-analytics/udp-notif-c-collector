...
typedef struct conn_ctx {
    ...
    int client_number; //print the number of the client connected who is currently talking
} conn_ctx;
...
static int chGoodCb(WOLFSSL* ssl, void* arg)
{
    ...
    arguments->client_number++; //we add +1 for the futur client connection identifiant
